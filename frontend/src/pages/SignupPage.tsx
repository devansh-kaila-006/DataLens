/**
 * Premium Signup Page
 * Sophisticated registration experience with enhanced visual design
 */
    ...
    <div className="min-h-screen bg-gradient-to-br from-navy-900 via-navy-800 to-navy-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {floatingPoints.map((point) => (
          <div
            key={point.id}
            className="absolute w-2 h-2 bg-indigo-400/10 rounded-full animate-float"
            style={{
              left: point.left,
              top: point.top,
      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 bg-gradient-to-br from-navy-800 to-navy-900 p-12 flex-col justify-between">
          <div className="space-y-8">
            <Link to="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Intelligent Data Analysis</p>
              </div>
            </Link>
          ...
          {/* Trust Badge */}
          <div className="inline-flex items-center gap-3 px-6 py-4 bg-navy-900/50 backdrop-blur-sm rounded-xl border border-slate-700">
            ...
            <div>
              ...
              <div className="text-xs text-slate-500">SOC 2 & GDPR Compliant</div>
            </div>
          </div>
        </div>
            ...
            <div className="lg:hidden mb-8 text-center">
              <Link to="/" className="inline-flex items-center gap-3">
                ...
                <div className="text-left">
                  <h1 className="text-xl font-bold text-white">DataLens</h1>
                  <p className="text-xs text-slate-400">Intelligent Data Analysis</p>
                </div>
              </Link>
            </div>
