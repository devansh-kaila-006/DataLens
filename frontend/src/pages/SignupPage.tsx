        ...
        <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 bg-gradient-to-br from-navy-800 to-navy-900 p-12 flex-col justify-between">
          <div className="space-y-8">
            <Link to="/" className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-200">DataLens</h1>
                <p className="text-sm text-gray-300">Intelligent Data Analysis</p>
              </div>
            </Link>
          ...
          <div className="inline-flex items-center gap-3 px-6 py-4 bg-gray-DARK_50/50 backdrop-blur-sm rounded-xl border border-slate-700">
            ...
            <div>
              ...
              <div className="text-xs text-gray-400">SOC 2 & GDPR Compliant</div>
            </div>
          </div>
        </div>
            ...
            <div className="lg:hidden mb-8 text-center">
              <Link to="/" className="inline-flex items-center gap-3">
                ...
                <div className="text-left">
                  <h1 className="text-xl font-bold text-gray-200">DataLens</h1>
                  <p className="text-xs text-gray-300">Intelligent Data Analysis</p>
                </div>
              </Link>
            </div>
