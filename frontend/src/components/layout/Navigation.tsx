...
export default function Navigation() {
  ...
  return (
    <nav className={`sticky top-0 z-50 transition-colors duration-150 ${
      isScrolled ? 'bg-white/95 backdrop-blur-sm shadow-sm border-b border-gray-200' : 'bg-white border-b border-gray-200'
    }`}>
          ...
          <div className="flex items-center gap-8">
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <div className="hidden sm:block">
                <h1 className="text-lg font-bold text-gray-900 group-hover:text-teal-600 transition-colors">DataLens</h1>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              {user ? (
                <div className="space-y-4">
                  ...
                  <button
                    onClick={handleSignOut}
                    className="w-full flex items-center gap-3 px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-md transition-colors"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                    </svg>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Link
                      to="/login"
                      className="block px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-md transition-colors"
                    >
                      Sign In
                    </Link>
                    <Link
