 ...
 * Sophisticated forms with enhanced UX and visual feedback
 */
  ...
  return (
    <div className="w-full max-w-md animate-scale-in">
      <div className="card-premium p-8 relative overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-emerald-400/10 to-indigo-400/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-br from-indigo-400/10 to-rose-400/10 rounded-full blur-2xl"></div>
