/**
 * v2 Landing Hero Component - Light theme, clean design
 * Professional hero with flat colors and minimal decoration
 */
        ...
        <div className="grid grid-cols-12 gap-8 items-center min-h-screen py-20">
          ...
          <div className="col-span-12 lg:col-span-7 space-y-8 animate-slide-up">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-50 border border-teal-200 text-teal-700 text-sm">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 leading-tight">
                Transform Data into
                <span className="text-teal-600"> Actionable Insights</span>
              </h1>
              ...
              <div className="card p-6 shadow-md">
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="text-center p-3 bg-gray-50 rounded-md border border-gray-200">
                      <div className="text-2xl font-bold text-gray-700">1.2K</div>
                      <div className="text-xs text-gray-500">Records</div>
                    </div>
                    <div className="text-center p-3 bg-gray-50 rounded-md border border-gray-200">
                      <div className="text-2xl font-bold text-warning-600">98%</div>
