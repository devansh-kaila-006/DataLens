...
export default function LandingHero() {
  return (
    <div className="relative bg-gray-DARK_50">
      {/* Main Content */}
        ...
        <div className="grid grid-cols-12 gap-8 items-center min-h-screen py-20">
          ...
          <div className="col-span-12 lg:col-span-7 space-y-8">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-indigo-600/20 border border-indigo-500/30 text-indigo-300 text-xs font-medium">
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-gray-DARK_400">
              ...
              <div className="space-y-1">
                <div className="text-3xl font-semibold text-white">&lt;2min</div>
              ...
              <div className="card p-6 shadow-md">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-base font-semibold text-white">Analysis Preview</h3>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="text-center p-3 bg-gray-DARK_200 rounded-md border border-gray-DARK_400">
                      <div className="text-2xl font-semibold text-gray-200">1.2K</div>
